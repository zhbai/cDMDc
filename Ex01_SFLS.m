...
for B_choice = 1:3      % 1-sub, 2-randn or 3-nonsub
    ...
    for CType = 1:3     % 1-unifrom, 2-gaussian 3-single pixel
        ...
        for ii = 1:2
            ...
            for k = 1:2
                ...
                if k == 2 && real(D01(1, 1)) == real(D01(2, 2))
                    ...
                    plot(1:8:n,imag(eval(strcat('Phi2', B_cond,'(1:8:n,k-1)'))), 'ro-', 'markersize', 4, 'linewidth', 1);
                    ...
                    plot(1:8:n,real(eval(strcat('Phi2', B_cond, '(1: 8: n, k)'))), 'ro-', 'markersize', 4,'linewidth', 1);
                    set(gca,'Xtick',[0, 256, 512, 768, 1024])
                end
                xlim([0, n])
                ylim([-.1, .1])
        ...
        if strcmp(B_cond,'2')
            ...
            plot((1:8:n),B22(1:8:n),'ro-', 'markersize', 4,'linewidth',1)
            xlim([0, n])
            ylim([-.1, .1])
            h = legend('True', 'DMDc', 'C-DMDc', 'CS-DMDc');
            set(h, 'fontsize', 13, 'location', 'southeast', 'box','on')
